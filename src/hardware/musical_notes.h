...
#define NOTE_Cs  NOTE_CS4
#define NOTE_D   NOTE_D4
#define NOTE_Ds  NOTE_DS4
#define NOTE_E   NOTE_E4
#define NOTE_F   NOTE_F4
#define NOTE_Fs  NOTE_FS4
#define NOTE_G   NOTE_G4
#define NOTE_Gs  NOTE_GS4
#define NOTE_A   NOTE_A4
#define NOTE_As  NOTE_AS4
#define NOTE_B   NOTE_B4

// Constantes de buzzer
#define FREQ_CAUTION    800
#define FREQ_WARNING    1200
#define FREQ_DANGER     1600
#define FREQ_EMERGENCY  2000

#define TONE_DURATION_SHORT   100
#define TONE_DURATION_MEDIUM  200
